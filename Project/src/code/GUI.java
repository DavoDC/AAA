...
public class GUI {
     ...
     *
     * @param Objects - Common name as a string - Enabled default - Visibled
     * default - Text color - Button color - Font as a string - Destination of
     * buttons
     *
    ...
    public void update(Room curLocation) {
        ...
        if (fullDesc.length == 1) {
            smallDesc += fullDesc[0] + ".";
        } else if (fullDesc.length >= 2) {
            smallDesc += (fullDesc[0] + "." + fullDesc[1] + ".");
        }
