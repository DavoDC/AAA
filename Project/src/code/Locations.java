...
public class Locations {
    ...
    private void addRoomItems() {
        ship.addItem(new Item("DamagedSpaceship", "The 3 damaged repulsors each require some conductive metal for repair", "Fixed"));
        ...
        events.addItem(new Item("NativeCrystal", "A magical cone-shaped crystal protected by the natives for generations", "Crs"));
